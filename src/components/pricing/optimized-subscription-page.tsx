...
const testimonials = [
  {
    ...
    content: "Digimytch m'a permis d'obtenir 3 entretiens dès la première semaine. Les suggestions IA étaient très pertinentes.",
    avatar: "SC"
  },
  {
    name: "Marcus Johnson", 
        ...
        >
          {isCanceling ? (
            ...
            <>
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Rejoignez les professionnels qui accélèrent leur parcours avec Digimytch Pro.
              </p>
            </>
          )}
        </motion.div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-lg relative overflow-hidden">
              ...
              <div className="text-center mb-6">
                <div className="flex items-center justify-center mb-2">
                  <h3 className="text-2xl font-bold text-gray-900">Digimytch Pro</h3>
                  {!hasProAccess && (
