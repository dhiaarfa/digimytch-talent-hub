...
export function DescriptionPoint({
  ...
  isImproved,
  isLoading,
  placeholder = tResume("Start with a strong action verb", "Commencez par un verbe d'action fort"),
  improvementPrompt = "",
  onImprovementPromptChange,
  improvementPromptPlaceholder = tResume(
    "e.g., Focus on technical implementation details and performance metrics",
    "ex. : détails techniques, métriques de performance"
  )
