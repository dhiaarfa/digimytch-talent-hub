  ...
  const handleSave = async () => {
    try {
      ...
      toast({
        ...
        description: error instanceof Error ? error.message : tResume("Unable to save your changes. Please try again.", "Impossible d'enregistrer. Réessayez."),
        variant: "destructive",
      });
    } finally {
              ...
              <Button 
                onClick={async () => {
                  try {
                    ...
                    toast({
                      title: tResume("Download started", "Téléchargement lancé"),
            ...
            >
              <div className="space-y-3">
                <label className="flex items-center space-x-2">
                  ...
                  />
                  <span className="text-sm font-medium text-foreground">{tResume("Resume", "CV")}</span>
                </label>
                <label className="flex items-center space-x-2">
                  <Checkbox 
                  ...
                  />
                  <span className="text-sm font-medium text-foreground">{L.coverLetterLabel}</span>
                </label>
              </div>
            </TooltipContent>
          </Tooltip>
