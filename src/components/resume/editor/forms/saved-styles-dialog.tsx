        ...
        <DialogHeader>
          <div className="flex items-center justify-between">
            <DialogTitle className="text-xl bg-gradient-to-r from-teal-700 to-cyan-700 
              ...
              {tResume("Saved Document Styles", "Styles de document sauvegardés")}
            </DialogTitle>
            <Button
              variant="outline"
              size="sm"
            ...
            >
              ...
              {tResume("Save Current", "Enregistrer l'actuel")}
            </Button>
          </div>
          <DialogDescription className="text-slate-600">
            {tResume(
              "Save current document settings or apply saved styles to your resume.",
              "Enregistrez la mise en page actuelle ou appliquez un style sauvegardé."
            )}
          </DialogDescription>
        </DialogHeader>
        <div className="grid gap-4 py-4">
          {isAddingNew && (
            <div className="flex items-center gap-2 bg-gradient-to-r from-teal-50/50 to-cyan-50/50 
              ...
              <Input
                placeholder={tResume("Enter style name...", "Nom du style…")}
                value={newStyleName}
              ...
              >
                {tResume("Save Style", "Enregistrer le style")}
              </Button>
              <Button
                variant="ghost"
                size="sm"
          ...
          <div className={isAddingNew ? "" : "border-t border-teal-100 pt-4"}>
            <Label className="text-sm font-medium mb-2 block text-slate-700">{L.savedStyles}</Label>
              ...
              <div className="p-4 space-y-3">
                {savedStyles.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-12 text-slate-500">
                    ...
                    <p className="text-sm">{tResume("No saved styles yet", "Aucun style enregistré")}</p>
                  </div>
                ) : (
