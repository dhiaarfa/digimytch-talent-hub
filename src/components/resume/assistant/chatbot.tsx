            ...
            <AlertDialog open={isAlertOpen} onOpenChange={setIsAlertOpen}>
              <AlertDialogTrigger asChild>
                <Button
                  ...
                  aria-label={L.clearChatHistory}
                  variant="ghost"
                  size="sm"
                >
                  <RefreshCw className="h-3 w-3" />
                  <span className="text-xs font-medium">{L.clearChatHistory}</span>
                </Button>
              </AlertDialogTrigger>
              <AlertDialogContent className={cn(
                ...
                <AlertDialogHeader>
                  <AlertDialogTitle>{L.clearChatHistoryTitle}</AlertDialogTitle>
                  <AlertDialogDescription>
                    {L.clearChatHistoryDesc}
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                  ...
                  >
                    {tResume("Clear Chat", "Effacer le chat")}
                  </AlertDialogAction>
                </AlertDialogFooter>
              </AlertDialogContent>
            </AlertDialog>
