      ...
      setErrorMessage({
        ...
        description:
          error instanceof Error
            ? error.message
            : "Impossible de créer le CV. Vérifiez votre profil et réessayez.",
      });
      setShowErrorDialog(true);
    } finally {
      setIsCreating(false);
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <DialogDescription className="text-sm text-gray-600">
                {currentStep === 1 
                  ? "Commencez par indiquer le poste visé"
                  : "Configurez le contenu de votre CV"
                }
              </DialogDescription>
            </div>
            {/* Step indicator */}
          ...
          {currentStep === 1 && (
            <div className="space-y-6">
              <div className="text-center space-y-2">
                <h3 className="text-xl font-semibold text-gray-900">Quel poste visez-vous ?</h3>
                <p className="text-gray-600">Cela permet d&apos;adapter le contenu et la structure du CV</p>
              </div>
                ...
                <div className="space-y-2">
                  ...
                  />
                   ...
                   <ul className="list-disc list-inside space-y-0.5 ml-4">
                     <li>Soyez précis (ex. « Développeur front-end » plutôt que « Développeur »)</li>
                     <li>Indiquez le niveau si pertinent (junior, senior…)</li>
                     <li>Alignez-vous sur le vocabulaire de l&apos;offre visée</li>
                   </ul>
                 </div>
              </div>
            </div>
            ...
            <div className="space-y-5">
              ...
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-3">
                <div className="text-sm text-purple-800">
                  <span className="font-medium">Poste visé :</span> {targetRole}
                </div>
              </div>

              {/* Import Options */}
              <div className="space-y-3">
                <Label className="text-sm font-medium text-gray-900">Contenu du CV</Label>
                ...
                {importOption === 'import-profile' && (
                  <div className="mt-4 space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {[
                        { key: 'work_experience', label: 'Expériences', data: profile.work_experience },
                        { key: 'projects', label: 'Projets', data: profile.projects },
                        { key: 'education', label: 'Formation', data: profile.education },
                        { key: 'skills', label: 'Compétences', data: profile.skills }
                      ].map((section) => (
