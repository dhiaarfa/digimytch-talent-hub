  ...
  return (
    <div className="grid grid-cols-2 gap-4">
      <ImportMethodRadioItem
        ...
        title={tResume("Tailor with AI", "Adapter avec l'IA")}
        description={tResume(
          "Let AI analyze the job description and optimize your resume for the best match",
          "L'IA analyse l'offre et optimise votre CV pour maximiser la correspondance"
        )}
      ...
      <ImportMethodRadioItem
        ...
        title={tResume("Copy Base Resume", "Copier le CV de base")}
        description={tResume(
          "Create a copy of your base resume. Add a job description to link it to a specific position.",
          "Copiez votre CV de base et liez-le à une offre via la description."
        )}
