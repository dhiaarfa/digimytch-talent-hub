...
export function AppHeader({
  ...
  useEffect(() => {
    ...
    if (!defaultModel) {
      const defaultModelId = getDefaultModel(effectiveIsPro);
      setDefaultModel(defaultModelId);
    }
  }, [defaultModel, effectiveIsPro, setDefaultModel]);
            ...
            <>
              ...
              <nav className="hidden md:flex items-center gap-1 lg:gap-2">
                ...
                <div className="mr-2 lg:mr-3">
                  <ClientOnly
                    fallback={
                      <div
                        className="w-[220px] lg:w-[260px] xl:w-[300px] h-8 rounded-md border border-purple-600/60 bg-white/50 px-3 flex items-center text-xs text-muted-foreground"
                        aria-hidden
                      >
                        Modèle IA
                      </div>
              ...
              <Sheet open={isOpen} onOpenChange={setIsOpen}>
                ...
                <SheetContent side="right" className="w-[280px] sm:w-[320px]">
                  ...
                  <TalentHubMobileNav onNavigate={() => setIsOpen(false)} />
                  <div className="flex flex-col gap-4 pt-6">
                    ...
                    <div className="px-1">
                      <ClientOnly
                        fallback={
                          <div
                            className="w-full h-10 rounded-md border border-purple-600/60 bg-white/50 px-3 flex items-center text-sm text-muted-foreground"
                            aria-hidden
                          >
                            Modèle IA
                          </div>
