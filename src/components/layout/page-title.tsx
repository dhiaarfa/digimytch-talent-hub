...
function getPageTitle(pathname: string): string {
  ...
  if (cleanSegments.length === 0) return "Tableau de bord";
  ...
  switch (lastSegment) {
    ...
    case "resumes": return "Mes CV";
    case "settings": return "Paramètres";
    case "home": return "Tableau de bord";
    case "jobs": return "Matching offres";
...
export function PageTitle() {
  ...
  useEffect(() => {
    ...
    if (baseTitle === "custom") {
      ...
      setTitle(truncateText(pageTitle || "Éditeur de CV"));
      setResumeType(type);
    } else {
