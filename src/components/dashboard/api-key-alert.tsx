              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <h3 className="text-base font-semibold bg-gradient-to-r from-purple-700 to-indigo-700 bg-clip-text text-transparent">
                    {variant === 'trial' ? 'Essai Pro gratuit 7 jours' : 'Débloquez toute la puissance IA'}
                  </h3>
                  {variant === 'trial' ? (
                ...
                <div className="flex flex-wrap items-center gap-3 text-xs text-gray-600 mb-2">
                  ...
                  <span>Modèles IA récents</span>
                  <span>Accès immédiat</span>
                </div>

                <p className="text-xs text-gray-500">
                  Rejoignez les professionnels qui accélèrent leur insertion avec Digimytch Talent Hub.
                </p>
              </div>
              ...
              <div className="mt-3 pt-3 border-t border-gray-200/60">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                  <div className="flex flex-wrap items-center gap-3 text-xs text-gray-500">
                    <span>Ou utilisez vos propres clés API :</span>
                    <a 
