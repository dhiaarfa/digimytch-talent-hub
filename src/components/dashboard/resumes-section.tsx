...
export function ResumesSection({ 
  ...
  const handleCopyResume = async (sourceResume: OptimisticResume) => {
    ...
    // Show immediate feedback
    toast.loading(`Copie de « ${sourceResume.name} »…`, { id: `copy-${sourceResume.id}` });
      ...
      <button className={cn(
        ...
        <div className={cn(
          ...
          <span className={cn(
            ...
            {type === 'base' ? 'Nouveau CV de base' : 'Nouveau CV sur mesure'}
          </span>
      ...
      <div className={cn(
        ...
        <div className={cn(
          ...
          <span className={cn(
            ...
            {type === 'base' ? 'Limite de CV de base atteinte' : 'Limite de CV sur mesure atteinte'}
          </span>
          <span className={cn(
            "mt-2 text-xs",
            "text-amber-600/70",
    ...
    return (
      <div className={cn(
        ...
        <AlertDialog>
              ...
              <div className={cn(
                ...
                <div className="absolute inset-0 bg-white/90 backdrop-blur-sm rounded-lg flex items-center justify-center z-10">
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <span className="text-xs font-medium text-blue-600">Copie…</span>
                  </div>
                </div>
              </div>
            ) : (
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>Supprimer le CV</AlertDialogTitle>
              <AlertDialogDescription>
                Voulez-vous vraiment supprimer « {resume.name} » ? Cette action est irréversible.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
              <AlertDialogCancel>Cancel</AlertDialogCancel>
