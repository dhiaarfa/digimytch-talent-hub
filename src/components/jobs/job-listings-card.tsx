        ...
        <div className="relative flex flex-col space-y-8">
          ...
          >
            {isLoading ? (
              ...
              const jobImage = resolveJobImage({
              ...
              >
                <Card className="group relative p-0 overflow-hidden hover:shadow-2xl transition-all duration-500 ease-out bg-gradient-to-br from-white/80 to-white/60 hover:from-white/90 hover:to-white/70 border-white/40 hover:border-white/60 rounded-2xl hover:-translate-y-1">
                  <EntityCardImage
                    src={jobImage.src}
                    alt={jobImage.alt}
                    variant="job"
