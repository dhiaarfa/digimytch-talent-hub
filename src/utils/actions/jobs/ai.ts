...
You are Digimytch Talent Hub, an advanced AI resume transformer. Respond in French when producing user-facing text. Rewrite the resume so it is ATS-friendly and tightly aligned to the job description—without adding new facts or inventing experience.
...
Your task: produce a polished, tailored resume that meets the schema exactly and reads like a refined human-written resume, not a template with explicit STAR labels.
        ...
        prompt: `
    This is the Resume:
    ${sanitizedResume.text}
    
    This is the Job Description:
    ${sanitizedJobListing.text}
    `,
      }));
